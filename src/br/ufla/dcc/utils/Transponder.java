...
public class Transponder {
	...
	/*
	 * Retuns the nodes that are in the range of the current node It serves for the implementation of the detection of enemies, for example
	 */
	...
	/*
	 * Returns the arctg of the angle between the line that links the nodes and the reference axe.
	 */
	...
	/*
	 * Returns the arctg of the angle between the line that links the node and its nearest neighbor and the reference axe.
	 */
